...
const Resume = (props) => {
  ...
  const projectsDetails = [
    ...
    },
    {
      ...
      subHeading:
        "Technologies Used:  WordPress, Templates",
    },
    {
  ...
  const resumeDetails = [
    <div className="resume-screen-container" key="education">
      <ResumeHeading
        ...
        subHeading={"Higher National Diploma in Computer Sience Hardware and Software Enginerring"}
        fromDate={"2019"}
        toDate={"2022"}
      />
      ...
      <div className="experience-container">
        ...
        <div className="experience-description">
          <span className="resume-description-text">
            Currently Freelancing, building websites and Maximising SEO for Websites
          </span>
        </div>
        <div className="experience-description">
          <span className="resume-description-text">
